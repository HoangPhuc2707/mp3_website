...
const activeStyle = 'px-4 text-main-500 font-semibold cursor-pointer border-b-2 border-main-500 h-[54px] flex items-center '
const Search = () => {
        ...
        <>
            ...
            <div className='w-full'>
                <div className='flex h-[50px] mb-7 items-center text-sm border-b border-gray-400 pl-[60px] pb-1'>
                    <span className='text-[20px] font-bold pr-6 border-r border-gray-400'>Kết quả tìm kiếm</span>
